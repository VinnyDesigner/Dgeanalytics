import svgPaths from "./svg-35yafawki3";
import imgImage48 from "figma:asset/f422c911ec06450953a867d6206398135341a3ad.png";
...
function Text() {
  return (
    <div className="absolute content-stretch flex h-[104px] items-start left-[calc(50%-449px)] top-[calc(50%-62px)] translate-x-[-50%] translate-y-[-50%] w-[318px]" data-name="Text">
...
function Group6() {
  return (
    <div className="absolute contents left-[calc(50%-289px)] top-[calc(50%-0.5px)] translate-x-[-50%] translate-y-[-50%]">
      <Text />
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[29.25px] left-[calc(50%-608px)] not-italic text-[18px] text-white top-[calc(50%+25px)] w-[638px]">{`A collaborative initiative bringing together Abu Dhabi's leading government technology organizations to provide seamless access to healthcare and education services across the UAE.`}</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="h-[468px] relative shrink-0 w-[1440px]">
      <div className="absolute flex h-[476px] items-center justify-center left-0 top-0 w-[1440px]">
        <div className="flex-none rotate-[180deg] scale-y-[-100%]">
          <div className="h-[476px] relative w-[1440px]" data-name="image 48">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
              <div className="absolute inset-0 overflow-hidden">
                <img alt="" className="absolute h-[113.39%] left-0 max-w-none top-0 w-full" src={imgImage48} />
              </div>
              <div className="absolute inset-0" style={{ backgroundImage: "linear-gradient(89.4813deg, rgba(7, 57, 107, 0) 1.1618%, rgb(7, 57, 107) 98.767%)" }} />
            </div>
          </div>
        </div>
      </div>
...
function Container1() {
  return (
    <div className="bg-[#eff6ff] content-stretch flex items-center p-[12px] relative rounded-[10px] shrink-0" data-name="Container">
      <Container2 />
    </div>
  );
}
...
function Group7() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] not-italic place-items-start relative shrink-0">
      <p className="[grid-area:1_/_1] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21.6px] ml-0 mt-0 relative text-[18px] text-black w-[217px]">Centralized Government Enabler</p>
      <p className="[grid-area:1_/_1] font-['Inter:Regular',sans-serif] font-normal leading-[23px] ml-0 mt-[61px] relative text-[#38383d] text-[16px] w-[246px]">Delivers quality services to the Abu Dhabi government employees, entities, citizens, and residents.</p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="content-stretch flex gap-[20px] items-start relative shrink-0 w-full">
      <div className="bg-[#094a8c] h-[44px] shrink-0 w-[4px]" />
      <Group7 />
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-start left-[30px] top-[30px] w-[270px]">
      <Container1 />
      <Frame15 />
    </div>
  );
...
function Group8() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] not-italic place-items-start relative shrink-0">
      <p className="[grid-area:1_/_1] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21.6px] ml-0 mt-0 relative text-[18px] text-black w-[118px]">Smart Digital Government</p>
      <p className="[grid-area:1_/_1] font-['Inter:Regular',sans-serif] font-normal leading-[22.4px] ml-0 mt-[61px] relative text-[#38383d] text-[16px] w-[236px]">Tackles the implementation of Abu Dhabi Government Digital Strategy 2025-2027, driving digital transformation and automation.</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="absolute content-stretch flex gap-[20px] items-start left-[30px] top-[94px]">
      <div className="bg-[#d9d374] h-[44px] shrink-0 w-[4px]" />
      <Group8 />
    </div>
  );
}
...
function Group9() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] not-italic place-items-start relative shrink-0">
      <p className="[grid-area:1_/_1] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21.6px] ml-[2px] mt-0 relative text-[18px] text-black w-[150px]">Team Behind The Teams</p>
      <p className="[grid-area:1_/_1] font-['Inter:Regular',sans-serif] font-normal leading-[22.4px] ml-0 mt-[61px] relative text-[#38383d] text-[16px] w-[246px]">{`The unified engine powering Abu Dhabi's transformation into a future-ready, digitally advanced government.`}</p>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="absolute content-stretch flex gap-[18px] items-start left-[30px] top-[94px]">
      <div className="bg-[#0bb811] h-[44px] shrink-0 w-[4px]" />
      <Group9 />
    </div>
  );
}
...
function Group10() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] not-italic place-items-start relative shrink-0">
      <p className="[grid-area:1_/_1] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21.6px] ml-[3px] mt-0 relative text-[18px] text-black w-[142px]">Geospatial Data Viewer</p>
      <p className="[grid-area:1_/_1] font-['Inter:Regular',sans-serif] font-normal leading-[22.4px] ml-0 mt-[65px] relative text-[#38383d] text-[16px] w-[246px]">Easy access to view maps and analyze spatial data across Abu Dhabi.</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="absolute content-stretch flex gap-[20px] items-start left-[30px] top-[98px]">
      <div className="bg-[#094a8c] h-[44px] shrink-0 w-[4px]" />
      <Group10 />
    </div>
  );
...
function Group11() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] not-italic place-items-start relative shrink-0">
      <p className="[grid-area:1_/_1] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21.6px] ml-0 mt-0 relative text-[18px] text-black w-[118px]">Open Data Sharing</p>
      <p className="[grid-area:1_/_1] font-['Inter:Regular',sans-serif] font-normal leading-[22.4px] ml-0 mt-[69px] relative text-[#38383d] text-[16px] w-[236px]">Facilitating the sharing and exchange of geospatial data among government agencies and stakeholders.</p>
    </div>
  );
}
...
function Group12() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] not-italic place-items-start relative shrink-0">
      <p className="[grid-area:1_/_1] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21.6px] ml-[2px] mt-0 relative text-[18px] text-black w-[150px]">Spatially Enabled Services</p>
      <p className="[grid-area:1_/_1] font-['Inter:Regular',sans-serif] font-normal leading-[22.4px] ml-0 mt-[69px] relative text-[#38383d] text-[16px] w-[246px]">GIS features standardized and locked with open and timely access to highly accurate data.</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 text-center w-full">
      <p className="font-['Arial:Bold',sans-serif] leading-[52px] relative shrink-0 text-[40px] text-white w-full">{`Explore Abu Dhabi's Spatial Data Ecosystem`}</p>
      <p className="font-['Arial:Regular',sans-serif] leading-[27px] relative shrink-0 text-[#e6f0fa] text-[18px] w-full">Discover how spatial data is transforming government services and enhancing decision-making across the emirate</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-white h-[59.2px] relative rounded-[10px] shrink-0 w-[226.637px]" data-name="Button">
      <Icon6 />
...
function Icon7() {
  return (
    <div className="absolute left-[33.6px] size-[20px] top-[19.6px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
...
function Button1() {
  return (
    <div className="h-[59.2px] relative rounded-[10px] shrink-0 w-[246.113px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[1.6px] border-solid border-white inset-0 pointer-events-none rounded-[10px]" />
      <Icon7 />
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[137.1px] not-italic text-[16px] text-center text-nowrap text-white top-[15.4px] translate-x-[-50%]">SDI Service Analytics</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col gap-[93px] items-center relative shrink-0 w-full">
      <Frame8 />
      <Frame9 />
    </div>
  );
...
function CtaSection() {
  return (
    <div className="content-stretch flex flex-col h-[389.2px] items-start overflow-clip px-0 py-[80px] relative shrink-0 w-full" data-name="CTASection" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 1440 389.2\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(0 -66.855 -75.259 0 720 194.6)\\'><stop stop-color=\\'rgba(255,255,255,1)\\' offset=\\'0.00078174\\'/><stop stop-color=\\'rgba(0,0,0,0)\\' offset=\\'0.00078174\\'/></radialGradient></defs></svg>'), linear-gradient(164.876deg, rgb(11, 31, 51) 0%, rgb(15, 61, 104) 100%)" }}>
      <Frame10 />
    </div>
  );
}
...
function Footer() {
  return (
    <div className="bg-[#0b1f33] h-[426px] relative shrink-0 w-full" data-name="Footer">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center pb-0 pl-[50px] pr-[24px] pt-[64px] relative size-full">
          <Frame11 />
        </div>
      </div>
    </div>
...
export default function Frame14() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[80px] items-center relative size-full">
      <Frame13 />
      <Frame7 />
      <Frame12 />
    </div>
