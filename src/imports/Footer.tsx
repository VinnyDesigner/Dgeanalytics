...
function Paragraph1() {
  return (
    <div className="h-[21px] opacity-70 relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[21px] left-[calc(50%+13.47px)] not-italic text-[#e6f0fa] text-[14px] text-center text-nowrap top-[-1.2px] translate-x-[-50%]">© 2025 SDI Service Analytics. Abu Dhabi Spatial Data Infrastructure.</p>
    </div>
  );
}
...
export default function Footer() {
  return (
    <div className="bg-[#0b1f33] flex flex-col gap-[27px] items-center pb-0 px-0 pt-[64px] relative w-full" data-name="Footer">
      <Container />
      <Container3 />
    </div>
  );
