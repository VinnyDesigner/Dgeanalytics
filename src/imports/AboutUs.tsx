import svgPaths from "./svg-0woou9mu0a";
...
function Text() {
  return (
    <div className="absolute content-stretch flex h-[104px] items-start left-[32px] top-[98px] w-[318px]" data-name="Text">
...
function Group6() {
  return (
    <div className="absolute contents left-[32px] top-[98px]">
      <Text />
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[29.25px] left-[32px] not-italic text-[18px] text-white top-[237px] w-[638px]">{`A collaborative initiative bringing together Abu Dhabi's leading government technology organizations to provide seamless access to healthcare and education services across the UAE.`}</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[30px] items-start left-[118px] top-[503px]">
      <Frame />
      <Frame1 />
    </div>
  );
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[40px] items-start left-[111px] top-[1089px]">
      <Frame4 />
      <Frame2 />
    </div>
  );
...
function Container18() {
  return (
    <div className="h-[229.2px] relative shrink-0 w-[1279.2px]" data-name="Container">
      <Heading />
      <Paragraph1 />
      <Container19 />
    </div>
...
function CtaSection() {
  return (
    <div className="absolute content-stretch flex flex-col h-[389.2px] items-start left-0 overflow-clip px-0 py-[80px] top-[1851.15px] w-[1279.2px]" data-name="CTASection" style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 1279.2 389.2\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'1\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(0 -66.855 -66.855 0 639.6 194.6)\\'><stop stop-color=\\'rgba(255,255,255,1)\\' offset=\\'0.00078174\\'/><stop stop-color=\\'rgba(0,0,0,0)\\' offset=\\'0.00078174\\'/></radialGradient></defs></svg>'), linear-gradient(163.077deg, rgb(11, 31, 51) 0%, rgb(15, 61, 104) 100%)" }}>
      <Container18 />
    </div>
  );
}
...
export default function AboutUs() {
  return (
    <div className="bg-[#f5f5f5] relative size-full" data-name="AboutUs">
      <div className="absolute flex h-[423px] items-center justify-center left-0 top-0 w-[1279px]">
