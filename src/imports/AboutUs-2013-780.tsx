import svgPaths from "./svg-853vkm7ynd";
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[30px] items-start left-[118px] top-[503px] w-[1042px]">
      <Frame />
      <Frame1 />
    </div>
  );
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[40px] items-start left-[111px] top-[1089px] w-[1049px]">
      <Frame4 />
      <Frame2 />
    </div>
  );
...
function CtaSection() {
  return (
    <div className="absolute h-[389.2px] left-0 overflow-clip top-[1851.15px] w-[1279.2px]" data-name="CTASection" style={{ backgroundImage: "linear-gradient(163.077deg, rgb(11, 31, 51) 0%, rgb(15, 61, 104) 100%)" }}>
      <Container18 />
      <Container19 />
    </div>
  );
...
export default function AboutUs() {
  return (
    <div className="bg-[#f5f5f5] relative size-full" data-name="AboutUs">
      ...
      <Frame6 />
      <CtaSection />
      <div className="absolute left-0 top-[2240px] w-[1279px]">
        <Footer />
      </div>
    </div>
  );
